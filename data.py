...
def get_cityscapes(root, batch_size, train_min_size, train_max_size, train_crop_size,
                   val_input_size,val_label_size, aug_mode,class_uniform_pct,train_split,val_split,
                   num_workers,ignore_value):
