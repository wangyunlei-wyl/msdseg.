...
class Camvid(data.Dataset):
    def __init__(self,root,image_set,transforms):
        ...
        #              "Sky",
        #              "Tree", ]
        # self.color_to_class={(0, 128, 192): 0,
        #                      (128, 0, 0): 1,
        #                      (64, 0, 128): 2,
        #                      (192, 192, 128): 3,
        #                      (64, 64, 128): 4,
        ...
        #                      (128, 128, 128): 9,
        #                      (128, 128, 0): 10,}
        self.color_to_class = {(128, 128, 128): 0,    # sky
                               (128, 0, 0): 1,    # Building
...
if __name__=='__main__':
    dataset=Camvid("../data/camvid/",image_set="test",transforms=T.ToTensor())
    t3=time.time()
