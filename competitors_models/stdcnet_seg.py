...
class BiSeNet(nn.Module):
    def __init__(self, backbone, n_classes, pretrain_model='',
                 pretrained='', change_num_classes=False,
                 use_boundary_2=False, use_boundary_4=False, use_boundary_8=False, use_boundary_16=False, use_conv_last=False, heat_map=False, *args, **kwargs):
...
def calculate_flops():
    ...
    model1 = BiSeNet('STDCNet1446', 19).eval()
    # print(model1)
...
if __name__ == "__main__":
    ...
    # model = BiSeNetV2(n_classes=19)
    # print(model)
    # scope(model, input_size=(3, 512, 1024))
    calculate_flops()
