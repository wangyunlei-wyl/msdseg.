...
class ContextPath(nn.Module):
    ...
    def forward(self, x):
        ...
        feat16_arm = F.interpolate(feat16_arm, size=feat32_up.shape[2:],
                                   mode='bilinear', align_corners=False)
...
class FeatureFusionModule(nn.Module):
    ...
    def forward(self, fsp, fcp):
        fcp = F.interpolate(fcp, size=fsp.shape[2:],
                                   mode='bilinear', align_corners=False)
...
class BiSeNetV1(nn.Module):
    ...
    def __init__(self, n_classes, aux_mode='eval', pretrained='',
                 change_num_classes=False,*args, **kwargs):
